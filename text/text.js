      ...
      <View style={styles.innerContainer}>
        ...
        <View>
          <Text style={styles.notes}>
            Kindly fill up this form only after you have completed the purchase
            at our partner site. We will verify your details and the cashback
            amount will be added to your account within 2 -3 Business days
        ...
        <View>
          ...
          {field.length
            ? field.map((item, i) => {
                if (item.type === "text") {
                  return (
                    <View style={styles.inputBoxContainer} key={i}>
                      <TextInput
                  ...
                  return (
                    <View
                      style={[styles.inputBoxContainer, styles.dateCon]}
                      key={i}
                    >
                      <Text
                        key={"FILE" + i}
                      ...
                      >
                        {fileResponse.hasOwnProperty(item.field_name)
                          ? fileResponse[item.field_name][0].name
                          : "Uploa File"}
                      </Text>
