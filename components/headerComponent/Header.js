        ...
        <Box sx={{position:"relative"}}>
         {
            searchInput ? <Box  sx={{alignItems:"center", display:"flex",justifyContent:"center",padding:"10px", width:"100%",position:"relative" }}>
               <input autoComplete="off" onChange={optimizedFunction} onKeyDown={(e) => handleKeyPress(e)} placeholder="Search Your Favorites Deals" id="header_input_search" className="header_input_search"></input>
               <button onClick={searchButtonClick} className="header_input_button" >
